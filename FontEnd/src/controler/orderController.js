...
function loadAllCustomerIds() {
    ...
    $.ajax({
        url: "http://localhost:8080/JavaEE/order?option=cmb_load_cus_id",
        method: "GET",
...
function selectedCustomer(CustomerId) {
    $.ajax({
        url: `http://localhost:8080/JavaEE/order?option=SelectedCus&cusId=${CustomerId}`,
        method: "GET",
        success: function (resp) {
            if (resp.status == 200) {
                for (const customer of resp.data) {
...
function loadAllItemIds() {
    ...
    $.ajax({
        url: "http://localhost:8080/JavaEE/order?option=cmb_load_item_id",
        method: "GET",
        success: function (resp) {
            if (resp.status == 200) {
...
function selectedItem(ItemId) {
    ...
    $.ajax({
        url: `http://localhost:8080/JavaEE/order?option=SelectedItem&itemId=${ItemId}`,
        method: "GET",
        success: function (resp) {
            if (resp.status == 200) {
                for (const item of resp.data) {
...
function purchaseOrder(){
    ...
    $.ajax({
        url: "http://localhost:8080/JavaEE/order",
        method: "POST",
